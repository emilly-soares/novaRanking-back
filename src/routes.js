...
routes.put("/business/ranking/:id", BusinessController.Ranking);
routes.get("/category/list", CategoryController.listNameCategory);
...
routes.post("/categorysave", authorizationMiddleware, CategoryController.store);
...
routes.put("/category:id", authorizationMiddleware, CategoryController.update);
